...
exports.updateAsset = async (oldData, data, patientID, currentUser) => {
  /***
  ...
  try {
    ...
    const pivot = JSON.parse(oldData);
    // Get the contract from the network.
    const contract = network.getContract("fabcar");
    console.log(data);
    pivot.radio = data.radio ? data.radio : '';
    pivot.report = data.report ? data.report : '';
